...
class ClientBase(BaseModel):
    ...
    address:     Optional[str] = Field(None, max_length=300, description="Dirección del inmueble")
    postal_code: Optional[str] = Field(None, max_length=5,   description="Código postal")
